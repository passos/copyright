...
func (_Token *TokenTransactor) InitialSupply(opts *bind.TransactOpts, _to common.Address) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "initialSupply", _to)
}

// InitialSupply is a paid mutator transaction binding the contract method 0x913093aa.
//
// Solidity: function initialSupply(_to address) returns(success bool)
func (_Token *TokenSession) InitialSupply(_to common.Address) (*types.Transaction, error) {
	return _Token.Contract.InitialSupply(&_Token.TransactOpts, _to)
}

// InitialSupply is a paid mutator transaction binding the contract method 0x913093aa.
//
// Solidity: function initialSupply(_to address) returns(success bool)
func (_Token *TokenTransactorSession) InitialSupply(_to common.Address) (*types.Transaction, error) {
	return _Token.Contract.InitialSupply(&_Token.TransactOpts, _to)
}
