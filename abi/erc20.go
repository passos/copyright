...
func (_Erc20 *Erc20Transactor) InitialSupply(opts *bind.TransactOpts, _to common.Address) (*types.Transaction, error) {
	return _Erc20.contract.Transact(opts, "initialSupply", _to)
}

// InitialSupply is a paid mutator transaction binding the contract method 0x913093aa.
//
// Solidity: function initialSupply(_to address) returns(success bool)
func (_Erc20 *Erc20Session) InitialSupply(_to common.Address) (*types.Transaction, error) {
	return _Erc20.Contract.InitialSupply(&_Erc20.TransactOpts, _to)
}

// InitialSupply is a paid mutator transaction binding the contract method 0x913093aa.
//
// Solidity: function initialSupply(_to address) returns(success bool)
func (_Erc20 *Erc20TransactorSession) InitialSupply(_to common.Address) (*types.Transaction, error) {
	return _Erc20.Contract.InitialSupply(&_Erc20.TransactOpts, _to)
}
